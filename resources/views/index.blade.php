            ...
            <table class="table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <th><a href="gradebook/edit/{{$gradebook['id']}}" class="link-primary link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">Изменить</a> 
                    
                    
                    <button type="button" class="btn btn-danger  js-delete-gradebook" data-gradebook-id="{{ $gradebook['id']}} ">Удалить</button></th>
                  </tr>
                  @endforeach
                </tbody>
              </table>
...
@section('scripts')
@vite(['resources/js/scripts/deleteGradebook'])
@endsection